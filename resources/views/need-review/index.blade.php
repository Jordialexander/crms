...
<div class="flex items-start justify-between mb-5">
    <div>
        <h1 class="text-[1.05rem] font-bold text-slate-900 leading-tight">Need Review</h1>
        <p class="text-[0.78rem] text-slate-400 mt-0.5">CR yang menunggu untuk mulai direview</p>
    </div>
</div>
...
<div class="bg-white border border-slate-200 rounded-xl px-4 py-3 mb-4 shadow-sm">
    <form method="GET" class="flex flex-wrap gap-2 items-end">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('need-review.index') }}"
    ...
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center"><a href="{{ route('need-review.show', $cr) }}" class="cr-number">{{ $cr->cr_number }}</a></td>
                    ...
                    <td class="text-center"><span class="cr-date">{{ $cr->submitted_at?->format('d M Y') ?? '-' }}</span></td>
                    <td class="text-center">
                        <a href="{{ route('need-review.show', $cr) }}"
                           class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[0.75rem] font-semibold
                            ...
                            <i class="bi bi-eye text-xs leading-none"></i> Review
                        </a>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="7" class="py-12 text-center">
                        ...
                        <span class="text-slate-400 text-[0.82rem]">Tidak ada CR yang perlu direview</span>
                    </td>
                </tr>
                @endforelse
            </tbody>
